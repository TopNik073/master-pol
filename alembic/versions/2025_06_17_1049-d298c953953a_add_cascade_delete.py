...
def upgrade() -> None:
    ...
    op.drop_constraint(op.f("products_import_type_id_fkey"), "products_import", type_="foreignkey")
    op.alter_column("products_import", "type_id", existing_type=sa.UUID(), nullable=True)
    ...
    op.drop_constraint(op.f("products_product_import_id_fkey"), "products", type_="foreignkey")
    op.alter_column("products", "product_import_id", existing_type=sa.UUID(), nullable=True)
    op.create_foreign_key(
...
def downgrade() -> None:
    ...
    op.alter_column("products", "product_import_id", existing_type=sa.UUID(), nullable=False)
    ...
    op.alter_column("products_import", "type_id", existing_type=sa.UUID(), nullable=False)
    # ### end Alembic commands ###